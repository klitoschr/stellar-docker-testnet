...
function prepare_dbs(){
	...
	docker run --name stellar-genesis -p 11626:11626 -p 11625:11625 --network=$TESTNET_NAME -v "$STELLAR_CONF:/etc/stellar/" -v "$WORKING_DIR/deployment/history:/mnt/stellar-hist/stellar-core-archive/node_001/" stellar/stellar-core:latest run
