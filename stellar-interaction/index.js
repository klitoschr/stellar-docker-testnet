...
const HORIZON_ENDPOINT = 'http://10.10.70.21:8000'
const NETWORK_PASSPHRASE = "Standalone UNIC_IFF Network ; JAN 2022"
...
const getFromFaucet = async (req,res) =>{
    try{
        ...
        if(pk){
            ...
            let sourceKeys = Stellar.Keypair.fromSecret("SCMWJA5CY26OKBMEKP4YWLCXXBQNPL4VXIQYBCFLXBD4UYQ3BV34OI2Z");
